...
public class SDAddNumberActivity extends BaseActivity implements CTitleBar.CTitleBarContainer {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btSubmit:
                ...
                //
                if(!numbers.contains(GlobalPara.strPhoneId))
                    numbers.add(GlobalPara.strPhoneId);
    ...
    private SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            SwipeMenuItem deleteItem = new SwipeMenuItem(SDAddNumberActivity.this)
